...
export class MyHondaPlusVehicleCardEditor extends LitElement {
  ...
  protected override render(): TemplateResult {
    return html`<div class="grid">
      ...
      <label
        >Nombre<input name="name" .value=${this.config.name ?? ""} @change=${this.updateField}
      /></label>
      <label
        >Modelo visual
      ...
      <label
        >Diseño<select name="layout" @change=${this.updateField}>
      ...
      >
      <label
        >Imagen<select name="image_mode" @change=${this.updateField}>
      ...
      <label
        >Datos antiguos después de (segundos)<input
          name="stale_after"
          type="number"
          min="300"
          step="300"
      ...
      <label class="check"
        ><input
          ...
          @change=${this.updateField}
        />
        Mostrar modelo detectado</label
      >
      <label class="check"
        ><input
          name="animate"
