...
const B = "myhondaplus-vehicle-card", Qe = "myhondaplus-vehicle-card-editor", Me = "0.9.1", C = {
  type: `custom:${B}`,
  name: "My Honda+",
...
function rt(t) {
  if (t === "civic") {
    const i = nt.replace('fill="currentColor"', 'fill="#20252b"'), o = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(i)}`;
    return d`<img
  ...
  const e = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(at)}`;
...
var ht = Object.defineProperty, ut = Object.getOwnPropertyDescriptor, m = (t, e, i, o) => {
  for (var s = o > 1 ? void 0 : o ? ut(e, i) : e, a = t.length - 1, n; a >= 0; a--)
...
let _ = class extends D {
  ...
  static async getConfigElement() {
    return await Promise.resolve().then(() => gt), document.createElement("myhondaplus-vehicle-card-editor");
  }
...
var pt = Object.defineProperty, Ct = Object.getOwnPropertyDescriptor, w = (t, e, i, o) => {
  for (var s = o > 1 ? void 0 : o ? Ct(e, i) : e, a = t.length - 1, n; a >= 0; a--)
    (n = t[a]) && (s = (o ? n(e, i, s) : n(s)) || s);
