 ...
 */
const j = globalThis, Y = j.ShadowRoot && (j.ShadyCSS === void 0 || j.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, X = Symbol(), o1 = /* @__PURE__ */ new WeakMap();
let _1 = class {
  constructor(e, i, o) {
...
let E = class extends HTMLElement {
  ...
  static createProperty(e, i = n1) {
    if (i.state && (i.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(e) && ((i = Object.create(i)).wrapped = !0), this.elementProperties.set(e, i), !i.noAccessor) {
      ...
      s !== void 0 && z1(this.prototype, e, s);
    }
  }
  static getPropertyDescriptor(e, i, o) {
    const { get: s, set: n } = H1(this.prototype, e) ?? { get() {
      return this[i];
    }, set(a) {
      this[i] = a;
    } };
  ...
  _$ET(e, i) {
    ...
    if (s !== void 0 && o.reflect === !0) {
      const a = (((n = o.converter) == null ? void 0 : n.toAttribute) !== void 0 ? o.converter : I).toAttribute(i, o.type);
  ...
  _$AK(e, i) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const r = o.getPropertyOptions(s), c = typeof r.converter == "function" ? { fromAttribute: r.converter } : ((n = r.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? r.converter : I;
      this._$Em = s;
  ...
  requestUpdate(e, i, o, s = !1, n) {
    ...
    if (e !== void 0) {
      ...
      if (s === !1 && (n = this[e]), o ?? (o = r.getPropertyOptions(e)), !((o.hasChanged ?? e1)(n, i) || o.useDefault && o.reflect && n === ((a = this._$Ej) == null ? void 0 : a.get(e)) && !this.hasAttribute(r._$Eu(e, o)))) return;
      this.C(e, i, o);
    }
...
const j1 = (t, e) => {
  ...
  for (let r = 0; r < i; r++) {
    const c = t[r];
    let C, u, h = -1, g = 0;
    for (; g < c.length && (a.lastIndex = g, u = a.exec(c), u !== null); ) g = a.lastIndex, a === H ? u[1] === "!--" ? a = l1 : u[1] !== void 0 ? a = d1 : u[2] !== void 0 ? (w1.test(u[2]) && (s = RegExp("</" + u[2], "g")), a = y) : u[3] !== void 0 && (a = y) : a === y ? u[0] === ">" ? (a = s ?? H, h = -1) : u[1] === void 0 ? h = -2 : (h = a.lastIndex - u[2].length, C = u[1], a = u[3] === void 0 ? y : u[3] === '"' ? C1 : h1) : a === C1 || a === h1 ? a = y : a === l1 || a === d1 ? a = H : (a = y, s = void 0);
    const _ = a === y && t[r + 1].startsWith("/>") ? " " : "";
    n += a === H ? c + N1 : h >= 0 ? (o.push(C), c.slice(0, h) + $1 + c.slice(h) + b + _) : c + b + (h === -2 ? r : _);
  }
  return [x1(t, n + (t[i] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), o];
};
class N {
  constructor({ strings: e, _$litType$: i }, o) {
    ...
    if (this.el = N.createElement(C, o), x.currentNode = this.el.content, i === 2 || i === 3) {
      const h = this.el.content.firstChild;
      h.replaceWith(...h.childNodes);
    }
    for (; (s = x.nextNode()) !== null && c.length < r; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const h of s.getAttributeNames()) if (h.endsWith($1)) {
          const g = u[a++], _ = s.getAttribute(h).split(b), V = /([.?@])?(.*)/.exec(g);
          c.push({ type: 1, index: n, name: V[2], strings: _, ctor: V[1] === "." ? B1 : V[1] === "?" ? F1 : V[1] === "@" ? q1 : W }), s.removeAttribute(h);
        ...
        if (w1.test(s.tagName)) {
          ...
          if (g > 0) {
            ...
            for (let _ = 0; _ < g; _++) s.append(h[_], D()), x.nextNode(), c.push({ type: 2, index: ++n });
            s.append(h[g], D());
          }
        }
      } else if (s.nodeType === 8) if (s.data === y1) c.push({ type: 2, index: n });
      else {
        let h = -1;
...
function O(t, e, i = t, o) {
  ...
  return (s == null ? void 0 : s.constructor) !== n && ((r = s == null ? void 0 : s._$AO) == null || r.call(s, !1), n === void 0 ? s = void 0 : (s = new n(t), s._$AT(t, i, o)), o !== void 0 ? (i._$Co ?? (i._$Co = []))[o] = s : i._$Cl = s), s !== void 0 && (e = O(t, s._$AS(t, e.values), s, o)), e;
}
class I1 {
  constructor(e, i) {
  ...
  u(e) {
    ...
    for (; c !== void 0; ) {
      if (a === c.index) {
        let C;
        c.type === 2 ? C = new R(n, n.nextSibling, this, e) : c.type === 1 ? C = new c.ctor(n, c.name, c.strings, this, e) : c.type === 6 && (C = new W1(n, this, e)), this._$AV.push(C), c = o[++r];
      }
...
class R {
  ...
  $(e) {
    var n;
    const { values: i, _$litType$: o } = e, s = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = N.createElement(x1(o.h, o.h[0]), this.options)), o);
    if (((n = this._$AH) == null ? void 0 : n._$AD) === s) this._$AH.p(i);
    else {
      const a = new I1(s, this), r = a.u(this.options);
  ...
  k(e) {
    ...
    const i = this._$AH;
    let o, s = 0;
    for (const n of e) s === i.length ? i.push(o = new R(this.O(D()), this.O(D()), this, this.options)) : o = i[s], o._$AI(n), s++;
    s < i.length && (this._$AR(o && o._$AB.nextSibling, s), i.length = s);
  }
  _$AR(e = this._$AA.nextSibling, i) {
    var o;
    for ((o = this._$AP) == null ? void 0 : o.call(this, !1, !0, i); e !== this._$AB; ) {
      const s = r1(e).nextSibling;
      r1(e).remove(), e = s;
    }
  }
  setConnected(e) {
...
class W {
  ...
  constructor(e, i, o, s, n) {
    this.type = 1, this._$AH = l, this._$AN = void 0, this.element = e, this.name = i, this._$AM = s, this.options = n, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = l;
  }
  _$AI(e, i = this, o, s) {
    ...
    if (n === void 0) e = O(this, e, i, 0), a = !U(e) || e !== this._$AH && e !== P, a && (this._$AH = e);
      ...
      const r = e;
      let c, C;
      for (e = n[0], c = 0; c < n.length - 1; c++) C = O(this, r[o + c], i, c), C === P && (C = this._$AH[c]), a || (a = !U(C) || C !== this._$AH[c]), C === l ? e = l : e !== l && (e += (C ?? "") + n[c + 1]), this._$AH[c] = C;
    }
    a && !s && this.j(e);
  }
  j(e) {
...
const G1 = (t, e, i) => {
  ...
  if (s === void 0) {
    ...
    o._$litPart$ = s = new R(e.insertBefore(D(), n), n, void 0, i ?? {});
  }
  return s._$AI(t), s;
};
/**
...
function i1(t) {
  return (e, i) => typeof i == "object" ? J1(t, e, i) : ((o, s, n) => {
...
function ie(t) {
  ...
  return ((i = te.find(([, o]) => o.test(e))) == null ? void 0 : i[0]) ?? "generic";
}
function oe(t) {
  return {
    civic: "Honda Civic",
...
var de = Object.defineProperty, he = Object.getOwnPropertyDescriptor, M = (t, e, i, o) => {
  for (var s = o > 1 ? void 0 : o ? he(e, i) : e, n = t.length - 1, a; n >= 0; n--)
...
let m = class extends L {
  ...
  async execute(t) {
    ...
    let s = o === "button" ? "press" : ((n = this.entity(t)) == null ? void 0 : n.state) === "on" ? "turn_off" : "turn_on";
  ...
  status(t, e, i, o, s) {
    const n = i === void 0 ? this.t("unavailable") : i ? o : s;
    return d`<div
  ...
  control(t, e, i) {
    ...
    const o = this.busy === i, s = this.entity(i), n = (c = this.entities[i]) == null ? void 0 : c.split(".")[0], a = s == null ? void 0 : s.state.toLowerCase(), r = !s || a === "unavailable" || a === "unknown" && n !== "button" && i !== "location";
    return d`<button
      type="button"
      aria-label=${e}
  ...
  render() {
    var n;
    const t = this.vehicleState(), e = t.locked === !0 ? this.t("locked") : t.locked === !1 ? this.t("unlocked") : this.t("unknown_state"), i = this.config.controls ?? [...p.controls], o = this.config.metrics ?? [...p.metrics], s = this.config.vehicle_alignment ?? p.vehicle_alignment;
    return d`<ha-card class=${this.config.animate === !1 ? "reduce-motion" : ""}>
      <header>
        <div>
          <h2>${this.config.name}</h2>
          ${this.config.show_model !== !1 ? d`<p>${oe(this.model())}</p>` : l}
        </div>
      ...
      <section
        class="vehicle align-${s} ${t.charging === !0 ? "is-charging" : ""}"
...
var Ce = Object.defineProperty, ue = Object.getOwnPropertyDescriptor, z = (t, e, i, o) => {
  for (var s = o > 1 ? void 0 : o ? ue(e, i) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (s = (o ? a(e, i, s) : a(s)) || s);
  return o && s && Ce(e, i, s), s;
};
let f = class extends L {
  ...
  checklist(t, e, i) {
    const o = new Set(this.config[e] ?? p[e]), s = this.detectedEntities();
    return d`<fieldset>
      <legend>${t}</legend>
      <div class="checks">
        ${i.map(([n, a]) => {
      const r = !this.config.device || !!s[n];
