 ...
 */
const V = globalThis, Y = V.ShadowRoot && (V.ShadyCSS === void 0 || V.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, X = Symbol(), o1 = /* @__PURE__ */ new WeakMap();
let v1 = class {
  constructor(e, i, o) {
  ...
  get styleSheet() {
    ...
    if (Y && e === void 0) {
      ...
      o && (e = o1.get(i)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), o && o1.set(i, e));
    }
    return e;
  }
  toString() {
...
const M1 = (t) => new v1(typeof t == "string" ? t : t + "", void 0, X), _1 = (t, ...e) => {
...
}, s1 = Y ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((e) => {
  let i = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: E1, defineProperty: L1, getOwnPropertyDescriptor: P1, getOwnPropertyNames: O1, getOwnPropertySymbols: H1, getPrototypeOf: z1 } = Object, _ = globalThis, a1 = _.trustedTypes, T1 = a1 ? a1.emptyScript : "", W = _.reactiveElementPolyfillSupport, H = (t, e) => t, j = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? T1 : null;
      break;
  ...
  return i;
} }, e1 = (t, e) => !E1(t, e), r1 = { attribute: !0, type: String, converter: j, reflect: !1, useDefault: !1, hasChanged: e1 };
...
let S = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, i, o) {
    const { get: s, set: r } = P1(this.prototype, e) ?? { get() {
      return this[i];
    }, set(a) {
      this[i] = a;
    } };
  ...
  static getPropertyOptions(e) {
    return this.elementProperties.get(e) ?? r1;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(H("properties"))) {
      const i = this.properties, o = [...O1(i), ...H1(i)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const s of o) i.unshift(s1(s));
    } else e !== void 0 && i.push(s1(e));
    return i;
  }
  static _$Eu(e, i) {
    const o = i.attribute;
  ...
  createRenderRoot() {
    ...
    return S1(e, this.constructor.elementStyles), e;
  }
  connectedCallback() {
    var e;
  ...
  _$ET(e, i) {
    ...
    if (s !== void 0 && o.reflect === !0) {
      const a = (((r = o.converter) == null ? void 0 : r.toAttribute) !== void 0 ? o.converter : j).toAttribute(i, o.type);
  ...
  _$AK(e, i) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const c = o.getPropertyOptions(s), n = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((r = c.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? c.converter : j;
      this._$Em = s;
  ...
  requestUpdate(e, i, o, s = !1, r) {
    ...
    if (e !== void 0) {
      ...
      if (s === !1 && (r = this[e]), o ?? (o = c.getPropertyOptions(e)), !((o.hasChanged ?? e1)(r, i) || o.useDefault && o.reflect && r === ((a = this._$Ej) == null ? void 0 : a.get(e)) && !this.hasAttribute(c._$Eu(e, o)))) return;
      this.C(e, i, o);
    }
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[H("elementProperties")] = /* @__PURE__ */ new Map(), S[H("finalized")] = /* @__PURE__ */ new Map(), W == null || W({ ReactiveElement: S }), (_.reactiveElementVersions ?? (_.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const z = globalThis, n1 = (t) => t, I = z.trustedTypes, c1 = I ? I.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, $1 = "$lit$", v = `lit$${Math.random().toFixed(9).slice(2)}$`, b1 = "?" + v, Z1 = `<${b1}>`, k = document, T = () => k.createComment(""), Z = (t) => t === null || typeof t != "object" && typeof t != "function", t1 = Array.isArray, U1 = (t) => t1(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", G = `[ 	
\f\r]`, O = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, l1 = /-->/g, d1 = />/g, y = RegExp(`>|${G}(?:([^\\s"'>=/]+)(${G}*=${G}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), h1 = /'/g, C1 = /"/g, y1 = /^(?:script|style|textarea|title)$/i, N1 = (t) => (e, ...i) => ({ _$litType$: t, strings: e, values: i }), d = N1(1), L = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), u1 = /* @__PURE__ */ new WeakMap(), w = k.createTreeWalker(k, 129);
function A1(t, e) {
...
const R1 = (t, e) => {
  ...
  for (let c = 0; c < i; c++) {
    const n = t[c];
    let C, u, l = -1, g = 0;
    for (; g < n.length && (a.lastIndex = g, u = a.exec(n), u !== null); ) g = a.lastIndex, a === O ? u[1] === "!--" ? a = l1 : u[1] !== void 0 ? a = d1 : u[2] !== void 0 ? (y1.test(u[2]) && (s = RegExp("</" + u[2], "g")), a = y) : u[3] !== void 0 && (a = y) : a === y ? u[0] === ">" ? (a = s ?? O, l = -1) : u[1] === void 0 ? l = -2 : (l = a.lastIndex - u[2].length, C = u[1], a = u[3] === void 0 ? y : u[3] === '"' ? C1 : h1) : a === C1 || a === h1 ? a = y : a === l1 || a === d1 ? a = O : (a = y, s = void 0);
    const m = a === y && t[c + 1].startsWith("/>") ? " " : "";
    r += a === O ? n + Z1 : l >= 0 ? (o.push(C), n.slice(0, l) + $1 + n.slice(l) + v + m) : n + v + (l === -2 ? c : m);
  }
  return [A1(t, r + (t[i] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), o];
};
class U {
  constructor({ strings: e, _$litType$: i }, o) {
    ...
    this.parts = [];
    let r = 0, a = 0;
    const c = e.length - 1, n = this.parts, [C, u] = R1(e, i);
    ...
    for (; (s = w.nextNode()) !== null && n.length < c; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const l of s.getAttributeNames()) if (l.endsWith($1)) {
          const g = u[a++], m = s.getAttribute(l).split(v), D = /([.?@])?(.*)/.exec(g);
          n.push({ type: 1, index: r, name: D[2], strings: m, ctor: D[1] === "." ? V1 : D[1] === "?" ? j1 : D[1] === "@" ? I1 : q }), s.removeAttribute(l);
        } else l.startsWith(v) && (n.push({ type: 6, index: r }), s.removeAttribute(l));
        if (y1.test(s.tagName)) {
      ...
      } else if (s.nodeType === 8) if (s.data === b1) n.push({ type: 2, index: r });
      else {
        let l = -1;
...
function P(t, e, i = t, o) {
  ...
  return (s == null ? void 0 : s.constructor) !== r && ((c = s == null ? void 0 : s._$AO) == null || c.call(s, !1), r === void 0 ? s = void 0 : (s = new r(t), s._$AT(t, i, o)), o !== void 0 ? (i._$Co ?? (i._$Co = []))[o] = s : i._$Cl = s), s !== void 0 && (e = P(t, s._$AS(t, e.values), s, o)), e;
}
class D1 {
  constructor(e, i) {
  ...
  u(e) {
    ...
    w.currentNode = s;
    let r = w.nextNode(), a = 0, c = 0, n = o[0];
    for (; n !== void 0; ) {
      if (a === n.index) {
        let C;
        n.type === 2 ? C = new N(r, r.nextSibling, this, e) : n.type === 1 ? C = new n.ctor(r, n.name, n.strings, this, e) : n.type === 6 && (C = new B1(r, this, e)), this._$AV.push(C), n = o[++c];
      }
      a !== (n == null ? void 0 : n.index) && (r = w.nextNode(), a++);
    }
...
class N {
  ...
  constructor(e, i, o, s) {
    this.type = 2, this._$AH = h, this._$AN = void 0, this._$AA = e, this._$AB = i, this._$AM = o, this.options = s, this._$Cv = (s == null ? void 0 : s.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, i = this) {
    e = P(this, e, i), Z(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== L && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : U1(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== h && Z(this._$AH) ? this._$AA.nextSibling.data = e : this.T(k.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    const { values: i, _$litType$: o } = e, s = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = U.createElement(A1(o.h, o.h[0]), this.options)), o);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === s) this._$AH.p(i);
    else {
      const a = new D1(s, this), c = a.u(this.options);
      a.p(i), this.T(c), this._$AH = a;
    }
  }
  _$AC(e) {
    let i = u1.get(e.strings);
    return i === void 0 && u1.set(e.strings, i = new U(e)), i;
  }
  k(e) {
    t1(this._$AH) || (this._$AH = [], this._$AR());
    const i = this._$AH;
    let o, s = 0;
    for (const r of e) s === i.length ? i.push(o = new N(this.O(T()), this.O(T()), this, this.options)) : o = i[s], o._$AI(r), s++;
    s < i.length && (this._$AR(o && o._$AB.nextSibling, s), i.length = s);
  }
  _$AR(e = this._$AA.nextSibling, i) {
    var o;
    for ((o = this._$AP) == null ? void 0 : o.call(this, !1, !0, i); e !== this._$AB; ) {
      const s = n1(e).nextSibling;
      n1(e).remove(), e = s;
    }
  }
  setConnected(e) {
...
class q {
  ...
  constructor(e, i, o, s, r) {
    this.type = 1, this._$AH = h, this._$AN = void 0, this.element = e, this.name = i, this._$AM = s, this.options = r, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = h;
  }
  _$AI(e, i = this, o, s) {
    const r = this.strings;
    let a = !1;
    if (r === void 0) e = P(this, e, i, 0), a = !Z(e) || e !== this._$AH && e !== L, a && (this._$AH = e);
    else {
      const c = e;
      let n, C;
      for (e = r[0], n = 0; n < r.length - 1; n++) C = P(this, c[o + n], i, n), C === L && (C = this._$AH[n]), a || (a = !Z(C) || C !== this._$AH[n]), C === h ? e = h : e !== h && (e += (C ?? "") + r[n + 1]), this._$AH[n] = C;
    }
    a && !s && this.j(e);
  }
  j(e) {
...
class I1 extends q {
  ...
  _$AI(e, i = this) {
    if ((e = P(this, e, i, 0) ?? h) === L) return;
    const o = this._$AH, s = e === h && o !== h || e.capture !== o.capture || e.once !== o.once || e.passive !== o.passive, r = e !== h && (o === h || s);
...
Q == null || Q(U, N), (z.litHtmlVersions ?? (z.litHtmlVersions = [])).push("3.3.3");
const F1 = (t, e, i) => {
  const o = (i == null ? void 0 : i.renderBefore) ?? e;
  let s = o._$litPart$;
  if (s === void 0) {
    const r = (i == null ? void 0 : i.renderBefore) ?? null;
    o._$litPart$ = s = new N(e.insertBefore(T(), r), r, void 0, i ?? {});
  }
  return s._$AI(t), s;
};
/**
...
class E extends S {
  ...
  update(e) {
    const i = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = F1(i, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
...
var m1;
E._$litElement$ = !0, E.finalized = !0, (m1 = x.litElementHydrateSupport) == null || m1.call(x, { LitElement: E });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const q1 = { attribute: !0, type: String, converter: j, reflect: !1, hasChanged: e1 }, W1 = (t = q1, e, i) => {
...
function i1(t) {
  return (e, i) => typeof i == "object" ? W1(t, e, i) : ((o, s, r) => {
...
const B = "myhondaplus-vehicle-card", G1 = "myhondaplus-vehicle-card-editor", x1 = "0.5.1", p = {
  type: `custom:${B}`,
  name: "My Honda+",
...
}, K1 = (t) => [t.entity_id, t.unique_id, t.translation_key, t.original_name].filter(Boolean).join(" ").toLowerCase();
function Y1(t, e = {}) {
  const i = { ...e };
  for (const [o, s] of Object.entries(J1)) {
    if (i[o]) continue;
    const r = t.filter((a) => !a.disabled_by).filter((a) => s.domains.includes(a.entity_id.split(".")[0] ?? "")).map((a) => {
      const c = K1(a), n = s.hints.reduce(
...
function te(t) {
  ...
  return ((i = ee.find(([, o]) => o.test(e))) == null ? void 0 : i[0]) ?? "generic";
}
function ie(t) {
  return {
    civic: "Honda Civic",
...
function ae(t, e, i) {
  ...
  return d`<svg class="vehicle-art" viewBox="0 0 960 360" role="img" aria-label="${t}">
    ...
    <path
      d="M95 245 Q120 198 210 182 L270 174 ${se} L840 196 Q894 207 915 254 L899 291 L790 300 Q778 235 705 235 Q632 235 620 300 L350 300 Q338 235 265 235 Q192 235 180 300 L87 284 Z"
      fill="url(#paint)"
...
const re = /* @__PURE__ */ new Set(["on", "open", "unlocked", "active", "charging", "plugged", "true"]), ne = /* @__PURE__ */ new Set(["unknown", "unavailable", "none"]);
function A(t) {
  return re.has((t == null ? void 0 : t.state.toLowerCase()) ?? "");
}
function K(t) {
  if (!t || ne.has(t.state.toLowerCase())) return "—";
...
var de = Object.defineProperty, he = Object.getOwnPropertyDescriptor, M = (t, e, i, o) => {
  for (var s = o > 1 ? void 0 : o ? he(e, i) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (s = (o ? a(e, i, s) : a(s)) || s);
  return o && s && de(e, i, s), s;
};
const Ce = ["lock", "climate", "refresh", "location"], ue = ["range", "battery", "odometer"];
let f = class extends E {
  constructor() {
    super(...arguments), this.config = { ...p }, this.entities = {};
  }
  static async getConfigElement() {
    return await Promise.resolve().then(() => fe), document.createElement("myhondaplus-vehicle-card-editor");
  }
  ...
  locale() {
    var t;
    return this.config.locale && this.config.locale !== "auto" ? this.config.locale : k1((t = this.hass) == null ? void 0 : t.language);
  }
  t(t, e = {}) {
  ...
  model() {
    return this.config.vehicle_model && this.config.vehicle_model !== "auto" ? this.config.vehicle_model : te(this.device);
  }
  paintColor() {
  ...
  render() {
    var s;
    const t = this.vehicleState(), e = t.locked === !0 ? this.t("locked") : t.locked === !1 ? this.t("unlocked") : this.t("unknown_state"), i = this.config.controls ?? [...Ce], o = this.config.metrics ?? [...ue];
    return d`<ha-card class=${this.config.animate === !1 ? "reduce-motion" : ""}>
      <header>
        <div>
          <h2>${this.config.name}</h2>
          ${this.config.show_model !== !1 ? d`<p>${ie(this.model())}</p>` : h}
        </div>
...
console.info(
  `%c MYHONDAPLUS-VEHICLE-CARD %c ${x1} `,
  "color:white;background:#a51d2d;font-weight:700",
  "color:#a51d2d;background:white;font-weight:700"
);
var pe = Object.defineProperty, ge = Object.getOwnPropertyDescriptor, R = (t, e, i, o) => {
