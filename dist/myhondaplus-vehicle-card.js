 ...
 */
const j = globalThis, Q = j.ShadowRoot && (j.ShadyCSS === void 0 || j.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, X = Symbol(), o1 = /* @__PURE__ */ new WeakMap();
let _1 = class {
  constructor(e, i, o) {
...
const z1 = (t) => new _1(typeof t == "string" ? t : t + "", void 0, X), b1 = (t, ...e) => {
...
}, s1 = Q ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((e) => {
  let i = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: D1, defineProperty: O1, getOwnPropertyDescriptor: L1, getOwnPropertyNames: T1, getOwnPropertySymbols: H1, getPrototypeOf: U1 } = Object, $ = globalThis, n1 = $.trustedTypes, Z1 = n1 ? n1.emptyScript : "", G = $.reactiveElementPolyfillSupport, T = (t, e) => t, I = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? Z1 : null;
      break;
  ...
  return i;
} }, e1 = (t, e) => !D1(t, e), a1 = { attribute: !0, type: String, converter: I, reflect: !1, useDefault: !1, hasChanged: e1 };
...
let E = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, i, o) {
    const { get: s, set: a } = L1(this.prototype, e) ?? { get() {
      return this[i];
    }, set(n) {
      this[i] = n;
    } };
    return { get: s, set(n) {
      ...
      a == null || a.call(this, n), this.requestUpdate(e, r, o);
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(T("properties"))) {
      const i = this.properties, o = [...T1(i), ...H1(i)];
  ...
  _$ET(e, i) {
    ...
    if (s !== void 0 && o.reflect === !0) {
      const n = (((a = o.converter) == null ? void 0 : a.toAttribute) !== void 0 ? o.converter : I).toAttribute(i, o.type);
  ...
  _$AK(e, i) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const r = o.getPropertyOptions(s), c = typeof r.converter == "function" ? { fromAttribute: r.converter } : ((a = r.converter) == null ? void 0 : a.fromAttribute) !== void 0 ? r.converter : I;
      this._$Em = s;
  ...
  requestUpdate(e, i, o, s = !1, a) {
    ...
    if (e !== void 0) {
      ...
      if (s === !1 && (a = this[e]), o ?? (o = r.getPropertyOptions(e)), !((o.hasChanged ?? e1)(a, i) || o.useDefault && o.reflect && a === ((n = this._$Ej) == null ? void 0 : n.get(e)) && !this.hasAttribute(r._$Eu(e, o)))) return;
      this.C(e, i, o);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const H = globalThis, r1 = (t) => t, B = H.trustedTypes, c1 = B ? B.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, $1 = "$lit$", b = `lit$${Math.random().toFixed(9).slice(2)}$`, y1 = "?" + b, N1 = `<${y1}>`, k = document, U = () => k.createComment(""), Z = (t) => t === null || typeof t != "object" && typeof t != "function", t1 = Array.isArray, R1 = (t) => t1(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", Y = `[ 	
\f\r]`, L = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, l1 = /-->/g, d1 = />/g, y = RegExp(`>|${Y}(?:([^\\s"'>=/]+)(${Y}*=${Y}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), h1 = /'/g, C1 = /"/g, w1 = /^(?:script|style|textarea|title)$/i, V1 = (t) => (e, ...i) => ({ _$litType$: t, strings: e, values: i }), h = V1(1), P = Symbol.for("lit-noChange"), l = Symbol.for("lit-nothing"), u1 = /* @__PURE__ */ new WeakMap(), x = k.createTreeWalker(k, 129);
function x1(t, e) {
...
function D(t, e, i = t, o) {
  ...
  return (s == null ? void 0 : s.constructor) !== a && ((r = s == null ? void 0 : s._$AO) == null || r.call(s, !1), a === void 0 ? s = void 0 : (s = new a(t), s._$AT(t, i, o)), o !== void 0 ? (i._$Co ?? (i._$Co = []))[o] = s : i._$Cl = s), s !== void 0 && (e = D(t, s._$AS(t, e.values), s, o)), e;
}
class I1 {
  constructor(e, i) {
  ...
  u(e) {
    ...
    x.currentNode = s;
    let a = x.nextNode(), n = 0, r = 0, c = o[0];
    for (; c !== void 0; ) {
      if (n === c.index) {
        let C;
        c.type === 2 ? C = new R(a, a.nextSibling, this, e) : c.type === 1 ? C = new c.ctor(a, c.name, c.strings, this, e) : c.type === 6 && (C = new W1(a, this, e)), this._$AV.push(C), c = o[++r];
      }
...
class R {
  ...
  $(e) {
    ...
    if (((a = this._$AH) == null ? void 0 : a._$AD) === s) this._$AH.p(i);
      ...
      const n = new I1(s, this), r = n.u(this.options);
  ...
  k(e) {
    ...
    const i = this._$AH;
    let o, s = 0;
    for (const a of e) s === i.length ? i.push(o = new R(this.O(U()), this.O(U()), this, this.options)) : o = i[s], o._$AI(a), s++;
...
class W {
  ...
  _$AI(e, i = this, o, s) {
    ...
    let n = !1;
    if (a === void 0) e = D(this, e, i, 0), n = !Z(e) || e !== this._$AH && e !== P, n && (this._$AH = e);
    else {
      const r = e;
      let c, C;
      for (e = a[0], c = 0; c < a.length - 1; c++) C = D(this, r[o + c], i, c), C === P && (C = this._$AH[c]), n || (n = !Z(C) || C !== this._$AH[c]), C === l ? e = l : e !== l && (e += (C ?? "") + a[c + 1]), this._$AH[c] = C;
    }
    n && !s && this.j(e);
  }
  j(e) {
...
J == null || J(N, R), (H.litHtmlVersions ?? (H.litHtmlVersions = [])).push("3.3.3");
const G1 = (t, e, i) => {
  const o = (i == null ? void 0 : i.renderBefore) ?? e;
  let s = o._$litPart$;
  if (s === void 0) {
    const a = (i == null ? void 0 : i.renderBefore) ?? null;
    o._$litPart$ = s = new R(e.insertBefore(U(), a), a, void 0, i ?? {});
  }
  return s._$AI(t), s;
};
/**
...
var v1;
z._$litElement$ = !0, z.finalized = !0, (v1 = A.litElementHydrateSupport) == null || v1.call(A, { LitElement: z });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Y1 = { attribute: !0, type: String, converter: I, reflect: !1, hasChanged: e1 }, J1 = (t = Y1, e, i) => {
...
function i1(t) {
  return (e, i) => typeof i == "object" ? J1(t, e, i) : ((o, s, a) => {
...
function ae(t) {
  if (t === "civic") {
    const i = se.replace('fill="currentColor"', 'fill="#20252b"'), o = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(i)}`;
    return h`<img
  ...
  const e = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(ne)}`;
  return h`<img class="vehicle-art honda-logo-art" src=${e} alt="Honda" />`;
}
...
var de = Object.defineProperty, he = Object.getOwnPropertyDescriptor, S = (t, e, i, o) => {
  for (var s = o > 1 ? void 0 : o ? he(e, i) : e, a = t.length - 1, n; a >= 0; a--)
...
let g = class extends z {
  ...
  locale() {
    var t;
    return this.config.locale && this.config.locale !== "auto" ? this.config.locale : M1((t = this.hass) == null ? void 0 : t.language);
  }
  t(t, e = {}) {
  ...
  control(t, e, i) {
    ...
    const o = this.busy === i, s = this.entity(i), a = (c = this.entities[i]) == null ? void 0 : c.split(".")[0], n = s == null ? void 0 : s.state.toLowerCase(), r = !s || n === "unavailable" || n === "unknown" && a !== "button" && i !== "location";
    return h`<button
      type="button"
      aria-label=${e}
    ...
    >
      <span aria-hidden="true"> ${o ? "…" : h`<ha-icon icon=${t}></ha-icon>`} </span>
      <small>${e}</small>
    </button>`;
  }
  vehicleVisual() {
    ...
    return h`<ha-card class=${this.config.animate === !1 ? "reduce-motion" : ""}>
      <header>
        <div>
          ...
          ${this.config.show_model !== !1 ? h`<p>${oe(this.model())}</p>` : l}
        </div>
        ${this.entities.lock ? h`<span class="badge ${t.locked === !1 ? "alert" : ""}">
                <ha-icon
...
var Ce = Object.defineProperty, ue = Object.getOwnPropertyDescriptor, O = (t, e, i, o) => {
  for (var s = o > 1 ? void 0 : o ? ue(e, i) : e, a = t.length - 1, n; a >= 0; a--)
    (n = t[a]) && (s = (o ? n(e, i, s) : n(s)) || s);
...
let f = class extends z {
  ...
  checklist(t, e, i) {
    ...
    return h`<fieldset>
      ...
      <div class="checks">
        ${i.map(([a, n]) => {
      const r = !this.config.device || !!s[a];
