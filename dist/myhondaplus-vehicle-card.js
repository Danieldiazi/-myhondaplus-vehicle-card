...
const E1 = (t) => new $1(typeof t == "string" ? t : t + "", void 0, X), b1 = (t, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: P1, defineProperty: O1, getOwnPropertyDescriptor: H1, getOwnPropertyNames: z1, getOwnPropertySymbols: T1, getPrototypeOf: Z1 } = Object, _ = globalThis, a1 = _.trustedTypes, U1 = a1 ? a1.emptyScript : "", q = _.reactiveElementPolyfillSupport, H = (t, e) => t, j = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? U1 : null;
      break;
  ...
  return i;
} }, e1 = (t, e) => !P1(t, e), r1 = { attribute: !0, type: String, converter: j, reflect: !1, useDefault: !1, hasChanged: e1 };
...
let S = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, i, o) {
    const { get: s, set: r } = H1(this.prototype, e) ?? { get() {
      return this[i];
    }, set(a) {
      this[i] = a;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(H("properties"))) {
      const i = this.properties, o = [...z1(i), ...T1(i)];
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[H("elementProperties")] = /* @__PURE__ */ new Map(), S[H("finalized")] = /* @__PURE__ */ new Map(), q == null || q({ ReactiveElement: S }), (_.reactiveElementVersions ?? (_.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const z = globalThis, n1 = (t) => t, I = z.trustedTypes, c1 = I ? I.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, y1 = "$lit$", v = `lit$${Math.random().toFixed(9).slice(2)}$`, A1 = "?" + v, N1 = `<${A1}>`, k = document, T = () => k.createComment(""), Z = (t) => t === null || typeof t != "object" && typeof t != "function", t1 = Array.isArray, R1 = (t) => t1(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", W = `[ 	
\f\r]`, O = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, l1 = /-->/g, d1 = />/g, y = RegExp(`>|${W}(?:([^\\s"'>=/]+)(${W}*=${W}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), h1 = /'/g, C1 = /"/g, w1 = /^(?:script|style|textarea|title)$/i, D1 = (t) => (e, ...i) => ({ _$litType$: t, strings: e, values: i }), d = D1(1), L = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), u1 = /* @__PURE__ */ new WeakMap(), w = k.createTreeWalker(k, 129);
function x1(t, e) {
...
const V1 = (t, e) => {
  ...
  for (let c = 0; c < i; c++) {
    const n = t[c];
    let C, u, l = -1, g = 0;
    for (; g < n.length && (a.lastIndex = g, u = a.exec(n), u !== null); ) g = a.lastIndex, a === O ? u[1] === "!--" ? a = l1 : u[1] !== void 0 ? a = d1 : u[2] !== void 0 ? (w1.test(u[2]) && (s = RegExp("</" + u[2], "g")), a = y) : u[3] !== void 0 && (a = y) : a === y ? u[0] === ">" ? (a = s ?? O, l = -1) : u[1] === void 0 ? l = -2 : (l = a.lastIndex - u[2].length, C = u[1], a = u[3] === void 0 ? y : u[3] === '"' ? C1 : h1) : a === C1 || a === h1 ? a = y : a === l1 || a === d1 ? a = O : (a = y, s = void 0);
    const m = a === y && t[c + 1].startsWith("/>") ? " " : "";
    r += a === O ? n + N1 : l >= 0 ? (o.push(C), n.slice(0, l) + y1 + n.slice(l) + v + m) : n + v + (l === -2 ? c : m);
  }
  return [x1(t, r + (t[i] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), o];
};
class U {
  constructor({ strings: e, _$litType$: i }, o) {
    ...
    for (; (s = w.nextNode()) !== null && n.length < c; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const l of s.getAttributeNames()) if (l.endsWith(y1)) {
          const g = u[a++], m = s.getAttribute(l).split(v), D = /([.?@])?(.*)/.exec(g);
          n.push({ type: 1, index: r, name: D[2], strings: m, ctor: D[1] === "." ? I1 : D[1] === "?" ? B1 : D[1] === "@" ? Q1 : F }), s.removeAttribute(l);
      ...
      } else if (s.nodeType === 8) if (s.data === A1) n.push({ type: 2, index: r });
      else {
        let l = -1;
...
class j1 {
  ...
  u(e) {
    ...
    for (; n !== void 0; ) {
      if (a === n.index) {
        let C;
        n.type === 2 ? C = new N(r, r.nextSibling, this, e) : n.type === 1 ? C = new n.ctor(r, n.name, n.strings, this, e) : n.type === 6 && (C = new F1(r, this, e)), this._$AV.push(C), n = o[++c];
      }
...
class N {
  ...
  _$AI(e, i = this) {
    e = P(this, e, i), Z(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== L && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : R1(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    ...
    if (((r = this._$AH) == null ? void 0 : r._$AD) === s) this._$AH.p(i);
      ...
      const a = new j1(s, this), c = a.u(this.options);
...
G == null || G(U, N), (z.litHtmlVersions ?? (z.litHtmlVersions = [])).push("3.3.3");
const q1 = (t, e, i) => {
...
var v1;
E._$litElement$ = !0, E.finalized = !0, (v1 = x.litElementHydrateSupport) == null || v1.call(x, { LitElement: E });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const W1 = { attribute: !0, type: String, converter: j, reflect: !1, hasChanged: e1 }, G1 = (t = W1, e, i) => {
...
function i1(t) {
  return (e, i) => typeof i == "object" ? G1(t, e, i) : ((o, s, r) => {
...
function ne(t, e, i) {
  return t === "civic" && m1 ? d`<svg
    ...
    >
      ...
      <path d=${m1} fill="currentColor" fill-rule="evenodd"></path>
    ...
    <path
      d="M95 245 Q120 198 210 182 L270 174 ${re[t]} L840 196 Q894 207 915 254 L899 291 L790 300 Q778 235 705 235 Q632 235 620 300 L350 300 Q338 235 265 235 Q192 235 180 300 L87 284 Z"
      fill="url(#paint)"
...
const ce = /* @__PURE__ */ new Set(["on", "open", "unlocked", "active", "charging", "plugged", "true"]), le = /* @__PURE__ */ new Set(["unknown", "unavailable", "none"]);
function A(t) {
  return ce.has((t == null ? void 0 : t.state.toLowerCase()) ?? "");
}
function K(t) {
  if (!t || le.has(t.state.toLowerCase())) return "—";
...
function he(t, e, i = Date.now()) {
  const o = t.updated ?? t.range ?? t.odometer, s = de(o, i);
  return {
...
var Ce = Object.defineProperty, ue = Object.getOwnPropertyDescriptor, M = (t, e, i, o) => {
  for (var s = o > 1 ? void 0 : o ? ue(e, i) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (s = (o ? a(e, i, s) : a(s)) || s);
  return o && s && Ce(e, i, s), s;
};
const pe = ["lock", "climate", "refresh", "location"], ge = ["range", "battery", "odometer"];
let f = class extends E {
  constructor() {
    super(...arguments), this.config = { ...p }, this.entities = {};
  }
  static async getConfigElement() {
    return await Promise.resolve().then(() => ve), document.createElement("myhondaplus-vehicle-card-editor");
  }
  ...
  render() {
    var s;
    const t = this.vehicleState(), e = t.locked === !0 ? this.t("locked") : t.locked === !1 ? this.t("unlocked") : this.t("unknown_state"), i = this.config.controls ?? [...pe], o = this.config.metrics ?? [...ge];
    return d`<ha-card class=${this.config.animate === !1 ? "reduce-motion" : ""}>
      <header>
        <div>
          <h2>${this.config.name}</h2>
          ${this.config.show_model !== !1 ? d`<p>${se(this.model())}</p>` : h}
        </div>
...
var fe = Object.defineProperty, me = Object.getOwnPropertyDescriptor, R = (t, e, i, o) => {
  for (var s = o > 1 ? void 0 : o ? me(e, i) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (s = (o ? a(e, i, s) : a(s)) || s);
