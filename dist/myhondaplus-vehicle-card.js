 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: O1, defineProperty: H1, getOwnPropertyDescriptor: z1, getOwnPropertyNames: Z1, getOwnPropertySymbols: T1, getPrototypeOf: U1 } = Object, _ = globalThis, r1 = _.trustedTypes, N1 = r1 ? r1.emptyScript : "", W = _.reactiveElementPolyfillSupport, H = (t, e) => t, I = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? N1 : null;
      break;
...
class D {
  ...
  _$AI(e, i = this) {
    e = P(this, e, i), U(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== L && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : R1(e) ? this.k(e) : this._(e);
  }
  O(e) {
...
class q {
  ...
  _$AI(e, i = this, o, s) {
    ...
    let a = !1;
    if (r === void 0) e = P(this, e, i, 0), a = !U(e) || e !== this._$AH && e !== L, a && (this._$AH = e);
    else {
      const c = e;
      let n, C;
      for (e = r[0], n = 0; n < r.length - 1; n++) C = P(this, c[o + n], i, n), C === L && (C = this._$AH[n]), a || (a = !U(C) || C !== this._$AH[n]), C === h ? e = h : e !== h && (e += (C ?? "") + r[n + 1]), this._$AH[n] = C;
    }
    a && !s && this.j(e);
  }
  j(e) {
...
Y == null || Y(N, D), (z.litHtmlVersions ?? (z.litHtmlVersions = [])).push("3.3.3");
const W1 = (t, e, i) => {
...
var _1;
E._$litElement$ = !0, E.finalized = !0, (_1 = x.litElementHydrateSupport) == null || _1.call(x, { LitElement: E });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const G1 = { attribute: !0, type: String, converter: I, reflect: !1, hasChanged: t1 }, Y1 = (t = G1, e, i) => {
...
function o1(t) {
  return (e, i) => typeof i == "object" ? Y1(t, e, i) : ((o, s, r) => {
