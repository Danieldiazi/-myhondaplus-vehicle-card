...
let b1 = class {
  ...
  get styleSheet() {
    ...
    if (X && e === void 0) {
      ...
      o && (e = a1.get(i)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), o && a1.set(i, e));
    }
    return e;
  }
  toString() {
...
}, n1 = X ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((e) => {
  let i = "";
...
let z = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, i, o) {
    const { get: s, set: n } = L1(this.prototype, e) ?? { get() {
      return this[i];
    }, set(a) {
      this[i] = a;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(O("properties"))) {
      const i = this.properties, o = [...O1(i), ...T1(i)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const s of o) i.unshift(n1(s));
    } else e !== void 0 && i.push(n1(e));
    return i;
  }
  static _$Eu(e, i) {
    const o = i.attribute;
  ...
  _$AK(e, i) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const r = o.getPropertyOptions(s), c = typeof r.converter == "function" ? { fromAttribute: r.converter } : ((n = r.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? r.converter : j;
      this._$Em = s;
  ...
  requestUpdate(e, i, o, s = !1, n) {
    ...
    if (e !== void 0) {
      ...
      if (s === !1 && (n = this[e]), o ?? (o = r.getPropertyOptions(e)), !((o.hasChanged ?? t1)(n, i) || o.useDefault && o.reflect && n === ((a = this._$Ej) == null ? void 0 : a.get(e)) && !this.hasAttribute(r._$Eu(e, o)))) return;
      this.C(e, i, o);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Y1 = { attribute: !0, type: String, converter: j, reflect: !1, hasChanged: t1 }, J1 = (t = Y1, e, i) => {
...
const B = "myhondaplus-vehicle-card", K1 = "myhondaplus-vehicle-card-editor", M1 = "0.6.0", p = {
  type: `custom:${B}`,
  name: "My Honda+",
...
function S1(t, e = {}) {
  ...
  for (const [o, s] of Object.entries(X1)) {
    ...
    const n = t.filter((a) => a.platform === "myhondaplus").filter((a) => !a.disabled_by).filter((a) => s.domains.includes(a.entity_id.split(".")[0] ?? "")).filter((a) => {
      ...
      const r = f1(a), c = s.hints.reduce(
        (u, C, h) => u + (r.includes(C) ? 100 - h : 0),
        0
      );
...
function ne(t) {
  ...
  const e = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(ae)}`;
...
var de = Object.defineProperty, he = Object.getOwnPropertyDescriptor, y = (t, e, i, o) => {
...
let m = class extends D {
  ...
  setConfig(t) {
    ...
    const e = { ...p, ...t };
    (this.config.vehicle_image !== e.vehicle_image || this.config.image_mode !== e.image_mode) && (this.customImageFailed = !1), this.config = e, this.entities = { ...t.entities ?? {} }, this.loadedDevice = void 0;
  }
  getCardSize() {
  ...
  vehicleVisual() {
    return this.config.image_mode === "custom" && this.config.vehicle_image && !this.customImageFailed ? d`<img
      ...
      />` : ne(this.customImageFailed ? "generic" : this.model());
  }
  visualStyle() {
  ...
  render() {
    ...
    return d`<ha-card class=${this.config.animate === !1 ? "reduce-motion" : ""}>
      ...
      ${this.config.layout !== "compact" || this.entities.climate ? d`<section
      ...
      ${this.config.show_controls !== !1 ? d`<nav class="controls" aria-label=${this.t("vehicle_controls")}>
              ${i.map((a) => {
      const r = {
        lock: {
...
y([
  g()
], m.prototype, "customImageFailed", 2);
m = y([
  k1(B)
], m);
  ...
  checklist(t, e, i) {
    ...
    return d`<fieldset>
      ...
      return d`<label class="check">
            ...
            />
            ${a}${r ? "" : ` — ${this.t("editor_not_available")}`}
          </label>`;
    })}
      </div>
    </fieldset>`;
