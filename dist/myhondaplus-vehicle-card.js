 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: E1, defineProperty: L1, getOwnPropertyDescriptor: P1, getOwnPropertyNames: O1, getOwnPropertySymbols: z1, getPrototypeOf: H1 } = Object, _ = globalThis, a1 = _.trustedTypes, T1 = a1 ? a1.emptyScript : "", q = _.reactiveElementPolyfillSupport, z = (t, e) => t, j = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? T1 : null;
      break;
...
let S = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(z("properties"))) {
      const i = this.properties, o = [...O1(i), ...z1(i)];
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[z("elementProperties")] = /* @__PURE__ */ new Map(), S[z("finalized")] = /* @__PURE__ */ new Map(), q == null || q({ ReactiveElement: S }), (_.reactiveElementVersions ?? (_.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const H = globalThis, n1 = (t) => t, I = H.trustedTypes, c1 = I ? I.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, $1 = "$lit$", v = `lit$${Math.random().toFixed(9).slice(2)}$`, b1 = "?" + v, Z1 = `<${b1}>`, k = document, T = () => k.createComment(""), Z = (t) => t === null || typeof t != "object" && typeof t != "function", t1 = Array.isArray, U1 = (t) => t1(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", W = `[ 	
\f\r]`, O = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, l1 = /-->/g, d1 = />/g, y = RegExp(`>|${W}(?:([^\\s"'>=/]+)(${W}*=${W}*(?:[^ 	
    ...
    for (; (s = w.nextNode()) !== null && n.length < c; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const l of s.getAttributeNames()) if (l.endsWith($1)) {
          ...
          n.push({ type: 1, index: r, name: D[2], strings: m, ctor: D[1] === "." ? V1 : D[1] === "?" ? j1 : D[1] === "@" ? I1 : F }), s.removeAttribute(l);
...
const G = H.litHtmlPolyfillSupport;
G == null || G(U, N), (H.litHtmlVersions ?? (H.litHtmlVersions = [])).push("3.3.3");
const Q1 = (t, e, i) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const F1 = { attribute: !0, type: String, converter: j, reflect: !1, hasChanged: e1 }, q1 = (t = F1, e, i) => {
...
function i1(t) {
  return (e, i) => typeof i == "object" ? q1(t, e, i) : ((o, s, r) => {
...
const B = "myhondaplus-vehicle-card", W1 = "myhondaplus-vehicle-card-editor", x1 = "0.5.1", p = {
  type: `custom:${B}`,
  name: "My Honda+",
...
function ae(t, e, i) {
  ...
  return d`<svg class="vehicle-art" viewBox="0 0 960 360" role="img" aria-label="${t}">
    ...
    <path
      d="M95 245 Q120 198 210 182 L270 174 ${se[t]} L840 196 Q894 207 915 254 L899 291 L790 300 Q778 235 705 235 Q632 235 620 300 L350 300 Q338 235 265 235 Q192 235 180 300 L87 284 Z"
      fill="url(#paint)"
