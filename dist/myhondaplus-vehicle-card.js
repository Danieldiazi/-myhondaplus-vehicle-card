 ...
 */
const j = globalThis, X = j.ShadowRoot && (j.ShadyCSS === void 0 || j.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, e1 = Symbol(), s1 = /* @__PURE__ */ new WeakMap();
let b1 = class {
  constructor(e, i, o) {
  ...
  get styleSheet() {
    ...
    if (X && e === void 0) {
      ...
      o && (e = s1.get(i)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), o && s1.set(i, e));
    }
    return e;
  }
  toString() {
...
const L1 = (t) => new b1(typeof t == "string" ? t : t + "", void 0, e1), y1 = (t, ...e) => {
...
}, a1 = X ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((e) => {
  let i = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: O1, defineProperty: H1, getOwnPropertyDescriptor: z1, getOwnPropertyNames: Z1, getOwnPropertySymbols: T1, getPrototypeOf: U1 } = Object, _ = globalThis, r1 = _.trustedTypes, N1 = r1 ? r1.emptyScript : "", W = _.reactiveElementPolyfillSupport, z = (t, e) => t, I = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? N1 : null;
      break;
  ...
  return i;
} }, t1 = (t, e) => !O1(t, e), n1 = { attribute: !0, type: String, converter: I, reflect: !1, useDefault: !1, hasChanged: t1 };
...
let S = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, i, o) {
    const { get: s, set: r } = z1(this.prototype, e) ?? { get() {
      return this[i];
    }, set(a) {
      this[i] = a;
    } };
  ...
  requestUpdate(e, i, o, s = !1, r) {
    ...
    if (e !== void 0) {
      ...
      if (s === !1 && (r = this[e]), o ?? (o = c.getPropertyOptions(e)), !((o.hasChanged ?? t1)(r, i) || o.useDefault && o.reflect && r === ((a = this._$Ej) == null ? void 0 : a.get(e)) && !this.hasAttribute(c._$Eu(e, o)))) return;
      this.C(e, i, o);
    }
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[z("elementProperties")] = /* @__PURE__ */ new Map(), S[z("finalized")] = /* @__PURE__ */ new Map(), W == null || W({ ReactiveElement: S }), (_.reactiveElementVersions ?? (_.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Z = globalThis, c1 = (t) => t, B = Z.trustedTypes, l1 = B ? B.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, w1 = "$lit$", v = `lit$${Math.random().toFixed(9).slice(2)}$`, A1 = "?" + v, D1 = `<${A1}>`, k = document, T = () => k.createComment(""), U = (t) => t === null || typeof t != "object" && typeof t != "function", i1 = Array.isArray, R1 = (t) => i1(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", G = `[ 	
\f\r]`, H = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, d1 = /-->/g, h1 = />/g, y = RegExp(`>|${G}(?:([^\\s"'>=/]+)(${G}*=${G}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), C1 = /'/g, u1 = /"/g, x1 = /^(?:script|style|textarea|title)$/i, V1 = (t) => (e, ...i) => ({ _$litType$: t, strings: e, values: i }), d = V1(1), P = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), p1 = /* @__PURE__ */ new WeakMap(), A = k.createTreeWalker(k, 129);
function k1(t, e) {
...
const j1 = (t, e) => {
  ...
  let s, r = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", a = H;
  for (let c = 0; c < i; c++) {
    const n = t[c];
    let C, u, l = -1, g = 0;
    for (; g < n.length && (a.lastIndex = g, u = a.exec(n), u !== null); ) g = a.lastIndex, a === H ? u[1] === "!--" ? a = d1 : u[1] !== void 0 ? a = h1 : u[2] !== void 0 ? (x1.test(u[2]) && (s = RegExp("</" + u[2], "g")), a = y) : u[3] !== void 0 && (a = y) : a === y ? u[0] === ">" ? (a = s ?? H, l = -1) : u[1] === void 0 ? l = -2 : (l = a.lastIndex - u[2].length, C = u[1], a = u[3] === void 0 ? y : u[3] === '"' ? u1 : C1) : a === u1 || a === C1 ? a = y : a === d1 || a === h1 ? a = H : (a = y, s = void 0);
    const m = a === y && t[c + 1].startsWith("/>") ? " " : "";
    r += a === H ? n + D1 : l >= 0 ? (o.push(C), n.slice(0, l) + w1 + n.slice(l) + v + m) : n + v + (l === -2 ? c : m);
  }
...
class N {
  constructor({ strings: e, _$litType$: i }, o) {
    ...
    if (this.el = N.createElement(C, o), A.currentNode = this.el.content, i === 2 || i === 3) {
      const l = this.el.content.firstChild;
      l.replaceWith(...l.childNodes);
    }
    for (; (s = A.nextNode()) !== null && n.length < c; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const l of s.getAttributeNames()) if (l.endsWith(w1)) {
        ...
        if (x1.test(s.tagName)) {
          ...
          if (g > 0) {
            ...
            for (let m = 0; m < g; m++) s.append(l[m], T()), A.nextNode(), n.push({ type: 2, index: ++r });
            s.append(l[g], T());
          }
        }
...
class I1 {
  ...
  u(e) {
    ...
    A.currentNode = s;
    let r = A.nextNode(), a = 0, c = 0, n = o[0];
    for (; n !== void 0; ) {
      if (a === n.index) {
        let C;
        n.type === 2 ? C = new D(r, r.nextSibling, this, e) : n.type === 1 ? C = new n.ctor(r, n.name, n.strings, this, e) : n.type === 6 && (C = new q1(r, this, e)), this._$AV.push(C), n = o[++c];
      }
      a !== (n == null ? void 0 : n.index) && (r = A.nextNode(), a++);
    }
...
class D {
  ...
  _$AI(e, i = this) {
    e = O(this, e, i), U(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== P && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : R1(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== h && U(this._$AH) ? this._$AA.nextSibling.data = e : this.T(k.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    const { values: i, _$litType$: o } = e, s = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = N.createElement(k1(o.h, o.h[0]), this.options)), o);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === s) this._$AH.p(i);
    else {
      const a = new I1(s, this), c = a.u(this.options);
      a.p(i), this.T(c), this._$AH = a;
    }
  }
  _$AC(e) {
    let i = p1.get(e.strings);
    return i === void 0 && p1.set(e.strings, i = new N(e)), i;
  }
  k(e) {
    i1(this._$AH) || (this._$AH = [], this._$AR());
    const i = this._$AH;
    let o, s = 0;
    for (const r of e) s === i.length ? i.push(o = new D(this.O(T()), this.O(T()), this, this.options)) : o = i[s], o._$AI(r), s++;
    s < i.length && (this._$AR(o && o._$AB.nextSibling, s), i.length = s);
  }
  _$AR(e = this._$AA.nextSibling, i) {
    var o;
    for ((o = this._$AP) == null ? void 0 : o.call(this, !1, !0, i); e !== this._$AB; ) {
      const s = c1(e).nextSibling;
      c1(e).remove(), e = s;
    }
  }
  setConnected(e) {
...
class q {
  ...
  _$AI(e, i = this, o, s) {
    ...
    let a = !1;
    if (r === void 0) e = O(this, e, i, 0), a = !U(e) || e !== this._$AH && e !== P, a && (this._$AH = e);
    else {
      const c = e;
      let n, C;
      for (e = r[0], n = 0; n < r.length - 1; n++) C = O(this, c[o + n], i, n), C === P && (C = this._$AH[n]), a || (a = !U(C) || C !== this._$AH[n]), C === h ? e = h : e !== h && (e += (C ?? "") + r[n + 1]), this._$AH[n] = C;
    }
    a && !s && this.j(e);
  }
  j(e) {
...
J == null || J(N, D), (Z.litHtmlVersions ?? (Z.litHtmlVersions = [])).push("3.3.3");
const W1 = (t, e, i) => {
  const o = (i == null ? void 0 : i.renderBefore) ?? e;
  let s = o._$litPart$;
  if (s === void 0) {
    const r = (i == null ? void 0 : i.renderBefore) ?? null;
    o._$litPart$ = s = new D(e.insertBefore(T(), r), r, void 0, i ?? {});
  }
  return s._$AI(t), s;
};
/**
...
class L extends S {
  ...
  update(e) {
    const i = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = W1(i, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const G1 = { attribute: !0, type: String, converter: I, reflect: !1, hasChanged: t1 }, J1 = (t = G1, e, i) => {
...
function o1(t) {
  return (e, i) => typeof i == "object" ? J1(t, e, i) : ((o, s, r) => {
...
const Q = "myhondaplus-vehicle-card", K1 = "myhondaplus-vehicle-card-editor", S1 = "0.5.1", p = {
  type: `custom:${Q}`,
  name: "My Honda+",
...
}, ee = (t) => [t.entity_id, t.unique_id, t.translation_key, t.original_name].filter(Boolean).join(" ").toLowerCase();
function te(t, e = {}) {
  const i = { ...e };
...
function se(t) {
  ...
  return ((i = oe.find(([, o]) => o.test(e))) == null ? void 0 : i[0]) ?? "generic";
}
function ae(t) {
  return {
    civic: "Honda Civic",
...
let f = class extends L {
  ...
  setConfig(t) {
    if (!t) throw new Error(m1("required_config", "es"));
  ...
  locale() {
    var t;
    return this.config.locale && this.config.locale !== "auto" ? this.config.locale : E1((t = this.hass) == null ? void 0 : t.language);
  }
  t(t, e = {}) {
    return m1(t, this.locale(), e);
  }
  ...
  model() {
    return this.config.vehicle_model && this.config.vehicle_model !== "auto" ? this.config.vehicle_model : se(this.device);
  }
  paintColor() {
  ...
  render() {
    ...
    return d`<ha-card class=${this.config.animate === !1 ? "reduce-motion" : ""}>
      ...
      ${this.config.debug ? d`<details class="diagnostics">
              ...
              <pre>
${f1(g1(this.hass, this.entities, this.model(), this.locale()))}</pre>
            </details>` : h}
    </ha-card>`;
  }
};
