 ...
 */
const V = globalThis, X = V.ShadowRoot && (V.ShadyCSS === void 0 || V.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ee = Symbol(), ae = /* @__PURE__ */ new WeakMap();
let be = class {
  constructor(e, i, o) {
  ...
  get styleSheet() {
    ...
    if (X && e === void 0) {
      ...
      o && (e = ae.get(i)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), o && ae.set(i, e));
    }
    return e;
  }
  toString() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Pe, defineProperty: Te, getOwnPropertyDescriptor: Oe, getOwnPropertyNames: Le, getOwnPropertySymbols: Ne, getPrototypeOf: Ie } = Object, y = globalThis, re = y.trustedTypes, Ue = re ? re.emptyScript : "", G = y.reactiveElementPolyfillSupport, O = (t, e) => t, j = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? Ue : null;
      break;
...
let z = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(O("properties"))) {
      const i = this.properties, o = [...Le(i), ...Ne(i)];
  ...
  _$ET(e, i) {
    ...
    if (s !== void 0 && o.reflect === !0) {
      const a = (((n = o.converter) == null ? void 0 : n.toAttribute) !== void 0 ? o.converter : j).toAttribute(i, o.type);
  ...
  _$AK(e, i) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const c = o.getPropertyOptions(s), r = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((n = c.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? c.converter : j;
      this._$Em = s;
  ...
  requestUpdate(e, i, o, s = !1, n) {
    ...
    if (e !== void 0) {
      ...
      if (s === !1 && (n = this[e]), o ?? (o = c.getPropertyOptions(e)), !((o.hasChanged ?? te)(n, i) || o.useDefault && o.reflect && n === ((a = this._$Ej) == null ? void 0 : a.get(e)) && !this.hasAttribute(c._$Eu(e, o)))) return;
      this.C(e, i, o);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$EP());
  }
  C(e, i, { useDefault: o, reflect: s, wrapped: n }, a) {
    o && !(this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(e) && (this._$Ej.set(e, a ?? i ?? this[e]), n !== !0 || a !== void 0) || (this._$AL.has(e) || (this.hasUpdated || o || (i = void 0), this._$AL.set(e, i)), s === !0 && this._$Em !== e && (this._$Eq ?? (this._$Eq = /* @__PURE__ */ new Set())).add(e));
  }
  async _$EP() {
...
z.elementStyles = [], z.shadowRootOptions = { mode: "open" }, z[O("elementProperties")] = /* @__PURE__ */ new Map(), z[O("finalized")] = /* @__PURE__ */ new Map(), G == null || G({ ReactiveElement: z }), (y.reactiveElementVersions ?? (y.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
class U {
  constructor({ strings: e, _$litType$: i }, o) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const c = e.length - 1, r = this.parts, [l, h] = je(e, i);
    if (this.el = U.createElement(l, o), k.currentNode = this.el.content, i === 2 || i === 3) {
      ...
      if (s.nodeType === 1) {
        ...
        if (xe.test(s.tagName)) {
          ...
          if (C > 0) {
            ...
            for (let b = 0; b < C; b++) s.append(p[b], N()), k.nextNode(), r.push({ type: 2, index: ++n });
            s.append(p[C], N());
          }
        }
      } else if (s.nodeType === 8) if (s.data === we) r.push({ type: 2, index: n });
      else {
        let p = -1;
        for (; (p = s.data.indexOf($, p + 1)) !== -1; ) r.push({ type: 7, index: n }), p += $.length - 1;
      }
      n++;
    }
  }
...
function P(t, e, i = t, o) {
  ...
  return (s == null ? void 0 : s.constructor) !== n && ((c = s == null ? void 0 : s._$AO) == null || c.call(s, !1), n === void 0 ? s = void 0 : (s = new n(t), s._$AT(t, i, o)), o !== void 0 ? (i._$Co ?? (i._$Co = []))[o] = s : i._$Cl = s), s !== void 0 && (e = P(t, s._$AS(t, e.values), s, o)), e;
}
class Fe {
  constructor(e, i) {
  ...
  u(e) {
    ...
    k.currentNode = s;
    let n = k.nextNode(), a = 0, c = 0, r = o[0];
    for (; r !== void 0; ) {
      if (a === r.index) {
        let l;
...
class R {
  ...
  constructor(e, i, o, s) {
    this.type = 2, this._$AH = u, this._$AN = void 0, this._$AA = e, this._$AB = i, this._$AM = o, this.options = s, this._$Cv = (s == null ? void 0 : s.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  $(e) {
    ...
    if (((n = this._$AH) == null ? void 0 : n._$AD) === s) this._$AH.p(i);
      ...
      const a = new Fe(s, this), c = a.u(this.options);
...
class W {
  ...
  constructor(e, i, o, s, n) {
    this.type = 1, this._$AH = u, this._$AN = void 0, this.element = e, this.name = i, this._$AM = s, this.options = n, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = u;
  }
  _$AI(e, i = this, o, s) {
    const n = this.strings;
    let a = !1;
    if (n === void 0) e = P(this, e, i, 0), a = !I(e) || e !== this._$AH && e !== H, a && (this._$AH = e);
    else {
      const c = e;
      let r, l;
      for (e = n[0], r = 0; r < n.length - 1; r++) l = P(this, c[o + r], i, r), l === H && (l = this._$AH[r]), a || (a = !I(l) || l !== this._$AH[r]), l === u ? e = u : e !== u && (e += (l ?? "") + n[r + 1]), this._$AH[r] = l;
    }
    a && !s && this.j(e);
  }
  j(e) {
...
class We extends W {
  ...
  _$AI(e, i = this) {
    if ((e = P(this, e, i, 0) ?? u) === H) return;
    const o = this._$AH, s = e === u && o !== u || e.capture !== o.capture || e.once !== o.once || e.passive !== o.passive, n = e !== u && (o === u || s);
...
function oe(t) {
  return (e, i) => typeof i == "object" ? Ke(t, e, i) : ((o, s, n) => {
...
const B = "myhondaplus-vehicle-card", Qe = "myhondaplus-vehicle-card-editor", Me = "1.0.1", _ = {
  type: `custom:${B}`,
  name: "My Honda+",
...
function ge(t, e, i, o) {
  ...
  return {
    ...
    locale: o,
    entities: Xe.map((n) => {
      const a = e[n], c = a == null ? void 0 : a.split(".")[0];
      return {
        key: n,
...
function Se(t, e = {}) {
  const i = { ...e };
  for (const [o, s] of Object.entries(et)) {
    if (i[o]) continue;
    const n = t.filter((a) => a.platform === "myhondaplus").filter((a) => !a.disabled_by).filter((a) => s.domains.includes(a.entity_id.split(".")[0] ?? "")).filter((a) => {
      const c = fe(a);
      return !(s.excludes ?? []).some((r) => c.includes(r));
    }).map((a) => {
      const c = fe(a), r = s.hints.reduce(
        (l, h, p) => l + (c.includes(h) ? 100 - p : 0),
        0
      );
      return { entry: a, score: r };
    }).filter(({ score: a }) => a > 0).sort((a, c) => c.score - a.score)[0];
    n && (i[o] = n.entry.entity_id);
  }
  return i;
}
function Ee(t, e, i = [], o, s = {}) {
  const n = e.filter((h) => h.platform === "myhondaplus"), a = new Set(
    n.filter((h) => h.device_id).map((h) => h.device_id)
  ), c = t.filter((h) => a.has(h.id)), r = o ? t.find((h) => h.id === o) : void 0, l = r ? Se(
    n.filter((h) => h.device_id === r.id),
    s
  ) : {};
  return {
    integrationDetected: n.length > 0 || i.includes("myhondaplus"),
    vehicles: c,
    selectedDevice: r,
    entities: l,
...
function ot(t) {
  ...
  return ((i = it.find(([, o]) => o.test(e))) == null ? void 0 : i[0]) ?? "generic";
}
function st(t) {
  return {
    civic: "Honda Civic",
...
function rt(t) {
  if (t === "civic") {
    const i = at.replace('fill="currentColor"', 'fill="#20252b"'), o = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(i)}`;
    return d`<img
  ...
  const e = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(nt)}`;
  return d`<img class="vehicle-art honda-logo-art" src=${e} alt="Honda" />`;
}
const ct = /* @__PURE__ */ new Set(["on", "open", "unlocked", "active", "charging", "plugged", "true"]), ze = /* @__PURE__ */ new Set(["unknown", "unavailable", "none"]);
function A(t) {
  if (!(!t || ze.has(t.state.toLowerCase())))
    return ct.has(t.state.toLowerCase());
}
function E(t) {
...
function lt(t, e = Date.now()) {
  if (!t) return;
  const i = Date.parse(t.last_updated);
  return Number.isFinite(i) ? Math.max(0, Math.floor((e - i) / 1e3)) : void 0;
}
function dt(t, e, i = Date.now()) {
  const o = t.updated ?? t.range ?? t.odometer, s = lt(o, i);
  return {
...
var ht = Object.defineProperty, ut = Object.getOwnPropertyDescriptor, f = (t, e, i, o) => {
  for (var s = o > 1 ? void 0 : o ? ut(e, i) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (s = (o ? a(e, i, s) : a(s)) || s);
  return o && s && ht(e, i, s), s;
};
let g = class extends D {
  constructor() {
    super(...arguments), this.config = { ..._ }, this.entities = {}, this.customImageFailed = !1, this.discoveryComplete = !1, this.integrationDetected = !1, this.vehicleCount = 0, this.compatibleEntityCount = 0;
  }
  static async getConfigElement() {
    return await Promise.resolve().then(() => mt), document.createElement("myhondaplus-vehicle-card-editor");
  }
  static getStubConfig() {
    const t = { ..._ };
    return delete t.statuses, t;
  }
  setConfig(t) {
    if (!t) throw new Error(Q("required_config", "es"));
    const e = { ..._, ...t };
    this.configuredStatuses = t.statuses ? [...t.statuses] : void 0, (this.config.vehicle_image !== e.vehicle_image || this.config.image_mode !== e.image_mode) && (this.customImageFailed = !1), this.config = e, this.entities = { ...t.entities ?? {} }, this.loadedDevice = void 0, this.discoveryComplete = !1;
  }
  getCardSize() {
  ...
  vehicleState() {
    return dt(
      this.entityRecord(),
      this.config.stale_after ?? _.stale_after
    );
  }
  model() {
    return this.config.vehicle_model && this.config.vehicle_model !== "auto" ? this.config.vehicle_model : ot(this.device);
  }
  paintColor() {
    const t = this.config.color_preset ?? _.color_preset;
    if (t !== "custom" && q[t]) return q[t].value;
    const e = this.config.vehicle_color ?? _.vehicle_color;
    return /^#[0-9a-f]{6}$/i.test(e) ? e : _.vehicle_color;
  }
  ageText(t) {
...
`)))) {
  ...
  status(t, e, i, o, s, n) {
    const a = o === void 0 ? this.t("unavailable") : o ? s : n;
    return d`<button
      type="button"
  ...
  renderStatus(t, e) {
    if (!this.entities[t]) return u;
    if (t === "location") return this.locationStatus();
    const i = {
      doors: {
        icon: "mdi:car-door",
        label: this.t("doors"),
  ...
  control(t, e, i) {
    var r;
    if (i === "location" || !this.entities[i]) return u;
    const o = this.busy === i, s = this.entity(i), n = (r = this.entities[i]) == null ? void 0 : r.split(".")[0], a = s == null ? void 0 : s.state.toLowerCase(), c = !s || a === "unavailable" || a === "unknown" && n !== "button";
    return d`<button
      type="button"
      aria-label=${e}
  ...
  vehicleVisual() {
    return this.config.image_mode === "custom" && this.config.vehicle_image && !this.customImageFailed ? d`<img
      ...
      />` : rt(this.customImageFailed ? "generic" : this.model());
  }
  visualStyle() {
  ...
  render() {
    var r;
    const t = this.vehicleState(), e = this.setupIssue(), i = t.locked === !0 ? this.t("locked") : t.locked === !1 ? this.t("unlocked") : this.t("unknown_state"), o = this.config.controls ?? [..._.controls], s = this.config.metrics ?? [..._.metrics], a = (this.configuredStatuses ?? (this.config.layout === "compact" ? ["climate", "location"] : [..._.statuses])).filter((l) => !!this.entities[l]), c = this.config.vehicle_alignment ?? _.vehicle_alignment;
    return d`<ha-card class=${this.config.animate === !1 ? "reduce-motion" : ""}>
      <header>
        <div>
          <h2>${this.config.name}</h2>
          ${this.config.show_model !== !1 ? d`<p>${st(this.model())}</p>` : u}
        </div>
      ...
      <div class="announcer" aria-live="polite">
        ${this.busy ? this.t("action_in_progress") : ((r = this.message) == null ? void 0 : r.text) ?? ""}
      </div>
      ${this.message ? d`<div class="message ${this.message.kind}">${this.message.text}</div>` : u}
      ${this.customImageFailed ? d`<div class="message error" role="alert">${this.t("custom_image_failed")}</div>` : u}
      ${e ? this.setupPanel(e) : d`<section
              class="vehicle align-${c} ${t.charging === !0 ? "is-charging" : ""}"
              style=${this.visualStyle()}
            >
              ${this.vehicleVisual()} ${this.freshness(t)}
            </section>`}
      ${e ? u : this.config.device ? d`<section class="metrics">
                ${s.map((l) => this.metric(l, t))}
              </section>` : d`<div class="setup">${this.t("select_vehicle")}</div>`}
      ${!e && a.length > 0 ? d`<section
              class="statuses ${this.config.layout === "compact" ? "compact-statuses" : ""}"
            >
              ${a.map((l) => this.renderStatus(l, t))}
            </section>` : u}
      ...
      return this.control(h.icon, h.label, l);
    })}
            </nav>` : u}
      ${this.config.debug ? d`<details class="diagnostics">
              ...
              <pre>
${Ce(ge(this.hass, this.entities, this.model(), this.locale()))}</pre>
            </details>` : u}
    </ha-card>`;
  }
};
...
f([
  m()
], g.prototype, "customImageFailed", 2);
f([
  m()
], g.prototype, "discoveryComplete", 2);
f([
  m()
], g.prototype, "integrationDetected", 2);
f([
  m()
], g.prototype, "vehicleCount", 2);
f([
  m()
], g.prototype, "compatibleEntityCount", 2);
g = f([
  ke(B)
], g);
...
var pt = Object.defineProperty, _t = Object.getOwnPropertyDescriptor, w = (t, e, i, o) => {
  for (var s = o > 1 ? void 0 : o ? _t(e, i) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (s = (o ? a(e, i, s) : a(s)) || s);
  return o && s && pt(e, i, s), s;
};
let v = class extends D {
  constructor() {
    super(...arguments), this.config = { ..._ }, this.devices = [], this.registryEntries = [], this.loading = !1, this.integrationDetected = !1, this.discoveryError = !1, this.automaticDiscoveryStarted = !1, this.statusesExplicit = !1;
  }
  setConfig(t) {
    this.statusesExplicit = t.statuses !== void 0, this.config = { ..._, ...t };
  }
  locale() {
    var t;
    return this.config.locale && this.config.locale !== "auto" ? this.config.locale : se((t = this.hass) == null ? void 0 : t.language);
    ...
    if (!(!this.hass || this.loading)) {
      ...
      try {
        ...
        this.integrationDetected = o.integrationDetected, this.devices = o.vehicles.sort(
          (s, n) => this.deviceName(s).localeCompare(this.deviceName(n))
  ...
  updateField(t) {
    ...
    this.statusesExplicit || delete o.statuses, e.name === "color_preset" && i !== "custom" && (o.vehicle_color = ((s = q[String(i)]) == null ? void 0 : s.value) ?? o.vehicle_color), this.config = o, this.dispatchEvent(
  ...
  toggleListValue(t, e) {
    ...
    const i = t.currentTarget, o = new Set(this.config[e] ?? _[e]);
  ...
  moveListValue(t, e, i) {
    ...
    const o = [...this.config[t] ?? _[t]], s = o.indexOf(e), n = s + i;
    if (s < 0 || n < 0 || n >= o.length) return;
    const a = o[s], c = o[n];
    if (a === void 0 || c === void 0) return;
    o[s] = c, o[n] = a;
    const r = { ...this.config, [t]: o };
  ...
  checklist(t, e, i, o = !1) {
    const s = [...this.config[e] ?? _[e]], n = new Set(s), a = new Map(i.map((l) => [l[0], l])), c = o ? [
      ...s.map((l) => a.get(l)).filter((l) => !!l),
      ...i.filter(([l]) => !n.has(l))
    ] : i, r = this.detectedEntities();
    return d`<fieldset>
      <legend>${t}</legend>
      <div class="checks ${o ? "ordered-checks" : ""}">
        ${c.map(([l, h]) => {
      const p = !this.config.device || !!r[l], C = s.indexOf(l);
      return d`<div class="check-row">
            <label class="check">
              <input
                type="checkbox"
                .value=${l}
                .checked=${n.has(l)}
                ?disabled=${!p && !n.has(l)}
                @change=${(b) => this.toggleListValue(b, e)}
              />
              <span>${h}${p ? "" : ` — ${this.t("editor_not_available")}`}</span>
            </label>
            ${o && C >= 0 ? d`<span class="order-buttons">
                    <button
                      type="button"
                      aria-label=${this.t("editor_move_up", { item: h })}
                      title=${this.t("editor_move_up", { item: h })}
                      ?disabled=${C === 0}
                      @click=${() => this.moveListValue(e, l, -1)}
                    >
                      <ha-icon icon="mdi:chevron-up" aria-hidden="true"></ha-icon>
                    </button>
                    <button
                      type="button"
                      aria-label=${this.t("editor_move_down", { item: h })}
                      title=${this.t("editor_move_down", { item: h })}
  ...
  capabilitySummary() {
    if (!this.config.device) return d`${u}`;
    ...
    return d`<div class="capabilities">
      ...
      return n.length === 0 ? u : d`<div class="capability-group">
                    <span>${this.t(o)}</span>
                    <div class="chips">
                      ${n.map(
      ...
      <section>
        ...
        <label
          ...
          <input
            ...
            max="140"
            step="5"
            .value=${String(this.config.vehicle_scale ?? _.vehicle_scale)}
      ...
      ([t, e]) => d`<option value=${t} ?selected=${this.config.color_preset === t}>
                ...
                ${this.config.color_preset === "custom" ? d`<label
                        ...
                        <input
                          name="vehicle_color"
                          type="color"
                          .value=${this.config.vehicle_color ?? _.vehicle_color}
                          @change=${this.updateField}
                        />
                      </label>` : u}
                <label
                  ...
                  <input
                    ...
                    max="100"
                    step="5"
                    .value=${String(this.config.shadow_intensity ?? _.shadow_intensity)}
                    @change=${this.updateField}
                  />
                </label>
              ` : u}
      ...
      <section>
        ...
        <label
          ...
          <input
            ...
            min="300"
            step="300"
            .value=${String(this.config.stale_after ?? _.stale_after)}
            @change=${this.updateField}
          />
        </label>
        <label class="check"
...
w([
  m()
], v.prototype, "registryEntries", 2);
w([
  m()
], v.prototype, "loading", 2);
w([
  m()
], v.prototype, "integrationDetected", 2);
w([
  m()
], v.prototype, "discoveryError", 2);
v = w([
  ke(Qe)
], v);
